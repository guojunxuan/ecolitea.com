...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    // Payload Cloud is permanently disabled for this deployment. Without this guard,
    // an unset Cloud URL is resolved by the browser as `/undefined/api/graphql`.
    if (!process.env.NEXT_PUBLIC_CLOUD_CMS_URL) {
      setUser(null)
      return
    }
